...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  1 17:34:23 2025
...
def activate_optimizer(lattice, selected_plane, target_node, kicker_strengths, x, xp):
    ...
    if success == True:
        ...
        po.plot_w_new_strengths_wXXp(lattice, hkickers, new_kicker_strengths,[round(x, 6),round(xp, 6)], "Sept5thCoImage43")
